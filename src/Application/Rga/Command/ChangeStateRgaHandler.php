...
class ChangeStateRgaHandler implements CommandHandlerInterface
{
    /** @var RgaRepository */
    private $repository;
    ...
    /**
     * @param MessageInterface|ChangeStateRga $message
     */
    public function run(MessageInterface $message): void
    {
        $rga = $this->repository->find($message->getIdentifier());
        
        $rga->stateRgaChanged(ValueObject\StateUuid::fromString($message->getStateUuid()));
