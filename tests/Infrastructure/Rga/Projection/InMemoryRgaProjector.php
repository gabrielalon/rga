...
namespace RGA\Test\Infrastructure\Rga\Projection;
...
use RGA\Test\Mock\Entity\Rga\Rga;

class InMemoryRgaProjector
	implements RgaProjectorInterface
{
	/** @var  */
	private $rgas = [];
	...
	{
		$this->rgas[$event->rgaUuid()->toString()] = (new Rga())
			->setUuid($event->rgaUuid())
