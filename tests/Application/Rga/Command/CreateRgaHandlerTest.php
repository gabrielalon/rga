...
use RGA\Application\Rga\Event\NewRgaCreated;
	...
	extends CommandHandlerTestCase
{
	...
	public function it_created_new_rga()
	{
        ...
        $this->assertEquals($entity->getSourceObjectItemQuantity()->toString(), $sourceObjectItem->getSourceItemQuantity());
		...
		foreach ($collection->getArrayCopy() as $eventStream)
		{
			...
			$this->assertTrue($entity->getIdentifier()->equals($entity->getIdentifier()));
