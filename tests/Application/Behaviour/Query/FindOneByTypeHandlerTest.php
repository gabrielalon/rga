...
class FindOneByTypeHandlerTest
	extends QueryHandlerTestCase
{
	 ...
	 * @test
	 */
	public function it_finds_behaviour_by_type()
	{
		$type = 'return';
		
		// given
		$view1 = $this->createBehaviourView(\Ramsey\Uuid\Uuid::uuid4()->toString(), $type);
		...
		$query = new V1\FindOneByType($type);
